...
public class LightCycleAndroidProcessorTest {
    ...
    private static final String DIFFERENT_OBJECT_FRAGMENT_DISPATCHER_BASE_CLASS_SRC = Joiner.on("\n").join(
            "package test;",
            "",
            "import android.app.Activity;",
            "import android.os.Bundle;",
            ...
            "import java.lang.SuppressWarnings;",
            "",
            "public class LightCycle_BaseFragmentAsObject<T extends String> extends BaseFragmentAsObject<T> {",
            "  private final FragmentLightCycleDispatcher<BaseFragmentAsObject<T>> lightCycleDispatcher = new FragmentLightCycleDispatcher<BaseFragmentAsObject<T>>();",
            "",
            "  private boolean bound;",
            "",
            "  @Override",
            "  public void bind(FragmentLightCycle<BaseFragmentAsObject<T>> lightCycle) {",
            "    lightCycleDispatcher.bind(lightCycle);",
            "  }",
            "",
            "  @Override",
            ...
            "",
            "  @SuppressWarnings(\"unchecked\")",
            "  private BaseFragmentAsObject<T> fragment() {",
            "    return (BaseFragmentAsObject<T>) this;",
            "  }",
            "",
            "  private void bindIfNecessary() {",
            "    if (!bound) {",
    ...
    private static final String DIFFERENT_OBJECT_SUPPORT_FRAGMENT_DISPATCHER_BASE_CLASS_SRC = Joiner.on("\n").join(
            "package test;",
            "",
            "import android.app.Activity;",
            "import android.os.Bundle;",
            ...
            "import java.lang.SuppressWarnings;",
            "",
            "public class LightCycle_BaseSupportFragmentAsObject<T extends String> extends BaseSupportFragmentAsObject<T> {",
            "  private final SupportFragmentLightCycleDispatcher<BaseSupportFragmentAsObject<T>> lightCycleDispatcher = new SupportFragmentLightCycleDispatcher<BaseSupportFragmentAsObject<T>>();",
            "",
            "  private boolean bound;",
            "",
            "  @Override",
            "  public void bind(SupportFragmentLightCycle<BaseSupportFragmentAsObject<T>> lightCycle) {",
            "    lightCycleDispatcher.bind(lightCycle);",
            "  }",
            "",
            "  @Override",
            ...
            "",
            "  @SuppressWarnings(\"unchecked\")",
            "  private BaseSupportFragmentAsObject<T> fragment() {",
            "    return (BaseSupportFragmentAsObject<T>) this;",
            "  }",
            "",
            "  private void bindIfNecessary() {",
            "    if (!bound) {",
    ...
    @Test
    public void shouldGenerateSubclassForFragmentsWithNonStandardFragment() {
        Truth.ASSERT.about(javaSource())
                .that(JavaFileObjects.forResource("test/BaseFragmentAsObject.java"))
                .processedWith(new LightCycleAndroidProcessor())
                .compilesWithoutError()
                .and()
                .generatesSources(forSourceString("test.LightCycle_BaseFragmentAsObject",
                        DIFFERENT_OBJECT_FRAGMENT_DISPATCHER_BASE_CLASS_SRC));
    }
    ...
    @Test
    public void shouldGenerateSubclassForSupportFragmentsWithNonStandardSupportFragment() {
        Truth.ASSERT.about(javaSource())
                .that(JavaFileObjects.forResource("test/BaseSupportFragmentAsObject.java"))
                .processedWith(new LightCycleAndroidProcessor())
                .compilesWithoutError()
                .and()
                .generatesSources(forSourceString("test.LightCycle_BaseSupportFragmentAsObject",
                        DIFFERENT_OBJECT_SUPPORT_FRAGMENT_DISPATCHER_BASE_CLASS_SRC));
    }

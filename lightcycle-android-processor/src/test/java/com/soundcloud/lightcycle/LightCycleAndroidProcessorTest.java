...
public class LightCycleAndroidProcessorTest {
    ...
    private static final String DIFFERENT_OBJECT_ACTIVITY_DISPATCHER_BASE_CLASS_SRC = Joiner.on("\n").join(
            ...
            "import java.lang.SuppressWarnings;",
            "",
            "public class LightCycle_BaseActivityAsObject<T extends String> extends BaseActivityAsObject<T> {",
    ...
    private static final String FRAGMENT_DISPATCHER_BASE_CLASS_SRC = Joiner.on("\n").join(
            ...
            "  private final FragmentLightCycleDispatcher<Fragment> lightCycleDispatcher = new FragmentLightCycleDispatcher<Fragment>();",
            "",
    ...
    private static final String SUPPORT_FRAGMENT_DISPATCHER_BASE_CLASS_SRC = Joiner.on("\n").join(
            "package test;",
            "",
            "import android.app.Activity;",
            "import android.os.Bundle;",
            ...
            "import java.lang.SuppressWarnings;",
            "",
            "public class LightCycle_SimpleBaseSupportFragment extends SimpleBaseSupportFragment {",
            "  private final SupportFragmentLightCycleDispatcher<Fragment> lightCycleDispatcher = new SupportFragmentLightCycleDispatcher<Fragment>();",
            "",
            "  private boolean bound;",
            "",
            "  @Override",
            ...
            "  @Override",
            "  public boolean onOptionsItemSelected(MenuItem item) {",
            "    return lightCycleDispatcher.onOptionsItemSelected(fragment(), item) || super.onOptionsItemSelected" +
                    "(item);",
            "  }",
            "",
            "  @Override",
    ...
    @Test
    public void shouldGenerateSubclassForSupportFragments() {
        Truth.ASSERT.about(javaSource())
                .that(JavaFileObjects.forResource("test/SimpleBaseSupportFragment.java"))
                .processedWith(new LightCycleAndroidProcessor())
                .compilesWithoutError()
                .and()
                .generatesSources(forSourceString("test.LightCycle_SimpleBaseSupportFragment",
                        SUPPORT_FRAGMENT_DISPATCHER_BASE_CLASS_SRC));
    }

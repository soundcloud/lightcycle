...
import com.soundcloud.lightcycle.sample.tracker.Screen;
...
public abstract class MyBaseActivity extends AppCompatActivity
    ...
    public void liftAndBind(ActivityLightCycle<Activity> lightCycle) {
        bind(LightCycleBinder.<Activity, MyBaseActivity>lift(lightCycle));
    }
